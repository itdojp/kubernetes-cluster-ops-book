...
- 更新差分を追う場合は、GitHub の [コミット履歴](https://github.com/itdojp/kubernetes-cluster-ops-book/commits/main/) と [Pull Requests](https://github.com/itdojp/kubernetes-cluster-ops-book/pulls) を参照してください。
